...
extract( shortcode_atts( array(
      ...
      if($img == '') {
    	...
    	$return = "<div class='member-img'><img src='".$img."' /></div>";
      }
...
function register_button_3($buttons) {  
   array_push($buttons, "accordion", "alert", "button", "divider", "dropcap", "video", "maps", "gap", "clear", "icon", "miniicon", "iconbox", "member", "skill", "pricing", "projects", "blog", "bloglist", "testimonial");  
   return $buttons;  
} 
